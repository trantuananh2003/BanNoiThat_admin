...
const EditProductItemExample: React.FC<Props> = ({ productId, setEditProduct }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await clientAPI
        .service("products")
        .put(`${productId}/product-items`, formData);
  ...
  return (
    <Box width="100%">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Box mt={3}>
          <Button variant="contained" color="success" onClick={addProductItem}>
            + Thêm sản phẩm
          </Button>
          <Button
            type="submit"
...
export default EditProductItemExample;
